...
parser.add_argument('--num_hidden_layer_encoder', type=int, default=0, help="number of channels in images")
parser.add_argument('--num_hidden_layer_decoder', type=int, default=0, help="number of channels in images")
...
parser.add_argument("--learn_output_sample_scale", action="store_true", default=False, help="allows for different scale per sample for each feature")
